...
using Test3.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace Test3.PublicWebGateway;

[DependsOn(
    typeof(Test3SharedHostingGatewaysModule)
)]
public class Test3PublicWebGatewayModule : AbpModule
{
