(function ($) {
    ...
    var contacts = {
        ...
        getContactTemplate: function (contact, hideDate) {
            ...
            var template = "\<a href=\"javascript:;\" class=\"chat-contact list-group-item list-group-item-action cursor-pointer px-2 border-2 rounded-2 mb-1 mt-0\" data-conversation-title=\"" + contacts.getName(contact) + "\" data-userid=\"" + contact.userId + "\" data-username=\"" + contact.username + "\" data-is-new-contact=" + isNewContact + ">" +
                "<div class=\"media \">" +
    ...
    var conversation = {
        ...
        getSentMessageTemplate: function (message) {
            ...
            var template = "<div class=\"media w-75 mw-65 w-lp-auto ms-auto mb-2\">" +
                "<div class=\"media-body position-relative  \">" +
                " <div class=\"card bg-primary shadow-sm rounded py-1 px-2 py-lg-2 px-lg-3 mb-1\">" +
                " <p class=\"text-small mb-0 text-white\">" + (message.message) + "</p>" +
                " </div>" +
                "<p class=\"small text-muted position-absolute text-end m-0\" style=\"opacity: 0.5; width: 50px; left: -60px; top: 4px; \">" + dateManager.formatMessageDate(message.messageDate) + "</p>" +
                " </div>" +
                "</div>";
