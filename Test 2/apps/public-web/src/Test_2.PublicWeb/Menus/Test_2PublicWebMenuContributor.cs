...
namespace Test_2.PublicWeb.Menus;

public class Test_2PublicWebMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public Test_2PublicWebMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<Test_2Resource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Test_2PublicWebMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Test_2PublicWebMenus.ProductPage,
                "Products",
                "/Products",
