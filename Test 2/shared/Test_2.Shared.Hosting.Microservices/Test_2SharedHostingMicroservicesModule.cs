...
namespace Test_2.Shared.Hosting.Microservices;
...
public class Test_2SharedHostingMicroservicesModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services
            .AddDataProtection()
            .SetApplicationName("Test_2")
            .PersistKeysToStackExchangeRedis(redis, "Test_2-Protection-Keys");
