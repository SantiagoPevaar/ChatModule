...
Necessary helm charts are created under `etc/k8s/test1` folder. Based on your back-office application UI, remove the other UI charts. Ex, if you are using **angular** UI, remove **web**, **blazor** and **blazor-server** charts.
...
``` 
to generate pfx file for signing tokens by AuthServer. Edit `Test1.AuthServer.csproj` file and uncomment item group section related to authserver.pfx:
```cs
<!-- <ItemGroup>
...
````powershell
127.0.0.1 test1-st-angular
127.0.0.1 test1-st-public-web
127.0.0.1 test1-st-authserver
127.0.0.1 test1-st-identity
127.0.0.1 test1-st-administration
127.0.0.1 test1-st-product
127.0.0.1 test1-st-saas
127.0.0.1 test1-st-gateway-web
127.0.0.1 test1-st-gateway-web-public
````
...
* Run `deploy-staging.ps1` in the `helm-chart` directory. It is deployed with the `test1` namespace.

* *You may wait ~30 seconds on first run for preparing the database*.

* Browse https://test1-st-public-web for public and
   https://test1-st-angular for the back-office application
