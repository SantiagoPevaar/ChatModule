...
using Test1.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace Test1.PublicWebGateway;

[DependsOn(
    typeof(Test1SharedHostingGatewaysModule)
)]
public class Test1PublicWebGatewayModule : AbpModule
{
