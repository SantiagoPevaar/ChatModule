...
namespace Test5.PublicWeb.Menus;

public class Test5PublicWebMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public Test5PublicWebMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<Test5Resource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Test5PublicWebMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Test5PublicWebMenus.ProductPage,
                "Products",
                "/Products",
