...
public class Test5DbMigrationService : ITransientDependency
{
    private readonly ILogger<Test5DbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IDataSeeder _dataSeeder;
    private readonly ICurrentTenant _currentTenant;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public Test5DbMigrationService(
        ILogger<Test5DbMigrationService> logger,
        ...
        CancellationToken cancellationToken)
    {
        using (var uow = _unitOfWorkManager.Begin(requiresNew: true, isTransactional: false))
        {
            ...
            await MigrateDatabaseAsync<ChatServiceDbContext>(cancellationToken);
