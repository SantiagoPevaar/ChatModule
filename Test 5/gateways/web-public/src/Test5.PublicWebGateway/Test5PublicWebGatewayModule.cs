...
using Test5.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace Test5.PublicWebGateway;

[DependsOn(
    typeof(Test5SharedHostingGatewaysModule)
)]
public class Test5PublicWebGatewayModule : AbpModule
{
