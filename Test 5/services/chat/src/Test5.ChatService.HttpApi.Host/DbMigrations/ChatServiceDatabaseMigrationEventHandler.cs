...
using Test5.Shared.Hosting.Microservices.DbMigrations;
using Volo.Abp.Data;
...
public class ChatServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<ChatServiceDbContext>,
