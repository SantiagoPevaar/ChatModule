...
namespace Test5.IdentityService.DbMigrations;
...
public class OpenIddictDataSeeder : IDataSeedContributor, ITransientDependency
{
    ...
    {
        await CreateSwaggerClientAsync("WebGateway", new[] { "AccountService", "IdentityService", "AdministrationService", "SaasService", "ProductService", "ChatService" });
    }
    ...
    private async Task CreateSwaggerClientAsync(string name, string[]? scopes = null)
    {
        ...
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            ...
            var chatServiceRootUrl = _configuration[$"OpenIddict:Resources:ChatService:RootUrl"]?.TrimEnd('/');
            ...
            await CreateApplicationAsync(
                ...
                redirectUris: new List<string> {
                    ...
                    $"{chatServiceRootUrl}/swagger/oauth2-redirect.html", // ChatService redirect uri
                }
            );
        }
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        await CreateApplicationAsync(
            ...
            scopes: commonScopes.Union(new[] {"AccountService", "IdentityService", "AdministrationService", "SaasService", "ProductService", "ChatService"}).ToList(),
        ...
        await CreateApplicationAsync(
            ...
            scopes: commonScopes.Union(new[] { "AccountService", "AdministrationService", "ProductService", "ChatService" }).ToList(),
