...
namespace Test4.PublicWeb.Menus;

public class Test4PublicWebMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public Test4PublicWebMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<Test4Resource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Test4PublicWebMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Test4PublicWebMenus.ProductPage,
                "Products",
                "/Products",
