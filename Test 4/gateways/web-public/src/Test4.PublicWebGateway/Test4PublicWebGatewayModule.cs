...
using Test4.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace Test4.PublicWebGateway;

[DependsOn(
    typeof(Test4SharedHostingGatewaysModule)
)]
public class Test4PublicWebGatewayModule : AbpModule
{
